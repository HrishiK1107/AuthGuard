    ...
    <div className="auth-v2-root">
      <main className="auth-v2-main">
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <select
            className="h-10 w-44 px-4 pr-10 rounded-md bg-neutral-900 border border-neutral-700 text-sm font-medium text-neutral-200 focus:outline-none"
        ...
        {/* CARD */}
        <div className="auth-card-elevated p-0">
          <div
